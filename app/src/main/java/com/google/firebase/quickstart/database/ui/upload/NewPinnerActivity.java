...
package com.google.firebase.quickstart.database.ui.upload;
...
public class NewPinnerActivity extends BaseActivity implements
        NewPostUploadTaskFragment.TaskCallbacks {
    public static final String TAG = "NewPinnerActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_pinner);
        ...
        mSubmitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                if (mResizedBitmap == null) {
                    Toast.makeText(NewPinnerActivity.this, "Select an image first.",
    ...
    public void onPostUploaded(final String error) {
        NewPinnerActivity.this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                mSubmitButton.setEnabled(true);
                //dismissProgressDialog();
                if (error == null) {
                    Toast.makeText(NewPinnerActivity.this, "UploadPost created!", Toast.LENGTH_SHORT).show();
                    finish();
                } else {
                    Toast.makeText(NewPinnerActivity.this, error, Toast.LENGTH_SHORT).show();
                }
            }
        });
    }

    public static int CAMERA_PERMISSION_REQUEST_CODE = 111;
