...
import com.google.firebase.quickstart.database.ui.upload.model.Author;
import com.google.firebase.quickstart.database.ui.upload.model.UploadPost;
                    ...
                    thumbnailRef.putBytes(thumbnailStream.toByteArray())
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            if (author == null) {
                                ...
                                mCallbacks.onPostUploaded("Not sign in");
                                return;
                            }
                            UploadPost newPost = new UploadPost(author, fullSizeUrl.toString(), fullSizeRef.toString(),
                            ...
                            ref.updateChildren(updatedUserData, new DatabaseReference.CompletionListener() {
                                ...
                                public void onComplete(DatabaseError firebaseError, DatabaseReference databaseReference) {
                                    if (firebaseError == null) {
                                        ...
                                        mCallbacks.onPostUploaded("Unable to create new post: " + firebaseError.getMessage());
                                    }
                                }
                            });
                        }
...
//                            FirebaseCrash.report(e);
                            mCallbacks.onPostUploaded("Failed to upload post to database");
                        }
                    });
                }
            }).addOnFailureListener(new OnFailureListener() {
