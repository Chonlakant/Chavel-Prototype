...
public class UploadActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private static final String TAG = "Storage#UploadActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ivBeforeUpload = findViewById(R.id.before_upload);
        ivAfterUpload = findViewById(R.id.after_upload);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == EZPhotoPick.PHOTO_PICK_GALLERY_REQUEST_CODE || requestCode == EZPhotoPick.PHOTO_PICK_CAMERA_REQUEST_CODE) {
            try {
                ...
                Uri ezFileUri = getImageUri(getApplicationContext(),pickedPhoto);

//                MultiTransformation<Bitmap> multi = new MultiTransformation<>(
//                        new CropTransformation(Utils.dip2px(context, 300), Utils.dip2px(context, 300)),
//                        new RoundedCornersTransformation(16, 0, RoundedCornersTransformation.CornerType.ALL)
//                );
...
//        startActivityForResult(intent, RC_TAKE_PICTURE);
        ...
        EZPhotoPick.startPhotoPickActivity(UploadActivity.this, config);
    }
    ...
    private void updateUI(FirebaseUser user) {
        ...
        if (mDownloadUrl != null) {
            ...
            //String thumbUrl = "https://firebasestorage.googleapis.com/v0/b/chavel-2a322.appspot.com/o/photos%2Fthumb_image%3A188?alt=media";
...
//                            new CropTransformation(Utils.dip2px(context, 300), Utils.dip2px(context, 300))))
            ...
            //Picasso.with(getApplicationContext()).load(thumbUrl).into(iv);
